...
public class InternalAlphaLexer extends Lexer {
    ...
    public final void mT__75() throws RecognitionException {
        try {
            int _type = T__75;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:74:7: ( 'xor' )
            // InternalAlpha.g:74:9: 'xor'
            {
            match("xor"); 
    ...
    public final void mT__76() throws RecognitionException {
        try {
            int _type = T__76;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:75:7: ( '!=' )
            // InternalAlpha.g:75:9: '!='
            {
            match("!="); 
    ...
    public final void mT__77() throws RecognitionException {
        try {
            int _type = T__77;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:76:7: ( 'not' )
            // InternalAlpha.g:76:9: 'not'
            {
            match("not"); 
    ...
    public final void mT__78() throws RecognitionException {
        try {
            int _type = T__78;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:77:7: ( 'as' )
            // InternalAlpha.g:77:9: 'as'
            {
            match("as"); 
    ...
    public final void mT__79() throws RecognitionException {
        try {
            int _type = T__79;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:78:7: ( 'domain' )
            // InternalAlpha.g:78:9: 'domain'
            {
            match("domain"); 
    ...
    public final void mT__80() throws RecognitionException {
        try {
            int _type = T__80;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:79:7: ( 'range' )
            // InternalAlpha.g:79:9: 'range'
            {
            match("range"); 
    ...
    public final void mT__81() throws RecognitionException {
        try {
            int _type = T__81;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:80:7: ( 'complement' )
            // InternalAlpha.g:80:9: 'complement'
            {
            match("complement"); 
    ...
    public final void mT__82() throws RecognitionException {
        try {
            int _type = T__82;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:81:7: ( 'affine-hull' )
            // InternalAlpha.g:81:9: 'affine-hull'
            {
            match("affine-hull"); 
    ...
    public final void mT__83() throws RecognitionException {
        try {
            int _type = T__83;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:82:7: ( 'poly-hull' )
            // InternalAlpha.g:82:9: 'poly-hull'
            {
            match("poly-hull"); 
    ...
    public final void mT__84() throws RecognitionException {
        try {
            int _type = T__84;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:83:7: ( 'reverse' )
            // InternalAlpha.g:83:9: 'reverse'
            {
            match("reverse"); 
    ...
    public final void mT__85() throws RecognitionException {
        try {
            int _type = T__85;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:84:7: ( 'cross' )
            // InternalAlpha.g:84:9: 'cross'
            {
            match("cross"); 
    ...
    public final void mT__86() throws RecognitionException {
        try {
            int _type = T__86;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:85:7: ( 'intersectRange' )
            // InternalAlpha.g:85:9: 'intersectRange'
            {
    ...
    public final void mT__87() throws RecognitionException {
        try {
            int _type = T__87;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:86:7: ( 'subtractRange' )
            // InternalAlpha.g:86:9: 'subtractRange'
            {
            match("subtractRange"); 
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:8894:14: ( ( 'true' | 'false' ) )
            // InternalAlpha.g:8894:16: ( 'true' | 'false' )
            {
            // InternalAlpha.g:8894:16: ( 'true' | 'false' )
            int alt1=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:8896:9: ( ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* | '\\'' ( 'a' .. 'z' | 'A' .. 'Z' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '*' | '(' | ')' | '-' | '_' | '+' | '=' | '|' | '/' | '?' | '0' .. '9' )+ '\\'' ) )
            // InternalAlpha.g:8896:11: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* | '\\'' ( 'a' .. 'z' | 'A' .. 'Z' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '*' | '(' | ')' | '-' | '_' | '+' | '=' | '|' | '/' | '?' | '0' .. '9' )+ '\\'' )
            {
            // InternalAlpha.g:8896:11: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* | '\\'' ( 'a' .. 'z' | 'A' .. 'Z' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '*' | '(' | ')' | '-' | '_' | '+' | '=' | '|' | '/' | '?' | '0' .. '9' )+ '\\'' )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalAlpha.g:8896:12: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
                    {
                    // InternalAlpha.g:8896:12: ( '^' )?
                    int alt2=2;
                    ...
                    // InternalAlpha.g:8896:41: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
                    loop3:
                    do {
                        int alt3=2;
                    ...
                    break;
                case 2 :
                    // InternalAlpha.g:8896:75: '\\'' ( 'a' .. 'z' | 'A' .. 'Z' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '*' | '(' | ')' | '-' | '_' | '+' | '=' | '|' | '/' | '?' | '0' .. '9' )+ '\\''
                    {
                    match('\''); 
                    // InternalAlpha.g:8896:80: ( 'a' .. 'z' | 'A' .. 'Z' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '*' | '(' | ')' | '-' | '_' | '+' | '=' | '|' | '/' | '?' | '0' .. '9' )+
                    int cnt4=0;
                    loop4:
                    do {
                        int alt4=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:8898:13: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalAlpha.g:8898:15: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:8900:10: ( ( '0' .. '9' )+ )
            // InternalAlpha.g:8900:12: ( '0' .. '9' )+
            {
            // InternalAlpha.g:8900:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:8902:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalAlpha.g:8902:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalAlpha.g:8902:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:8904:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalAlpha.g:8904:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalAlpha.g:8904:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:8906:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalAlpha.g:8906:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalAlpha.g:8906:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAlpha.g:8908:16: ( . )
            // InternalAlpha.g:8908:18: .
            {
            matchAny(); 
    ...
    static final String[] DFA13_transitionS = {
            ...
            "\1\u0112",
            "\1\u0113",
            "\1\u0114\2\uffff\12\62\7\uffff\32\62\4\uffff\1\62\1\uffff\32\62",
            "\1\u0116",
            "\12\62\7\uffff\32\62\4\uffff\1\62\1\uffff\32\62",
            "\12\62\7\uffff\32\62\4\uffff\1\62\1\uffff\32\62",
            "\1\u0119",

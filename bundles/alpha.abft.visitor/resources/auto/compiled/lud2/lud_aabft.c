...
#define check_U_i_0(i) check_U_i_0[((-1 + N - i >= 0 && -1 + i >= 0) ? (i) : 0)]
#define check_U_i_1(i) check_U_i_1[((-1 + N - i >= 0 && -1 + i >= 0) ? (i) : 0)]
#define check_U_j_0(j) check_U_j_0[((-1 + N - j >= 0 && -1 + j >= 0) ? (j) : 0)]
#define check_U_j_1(j) check_U_j_1[((-1 + N - j >= 0 && -1 + j >= 0) ? (j) : 0)]
#define check_L_i_0(i) check_L_i_0[((-1 + N - i >= 0 && -1 + i >= 0) ? (i) : 0)]
#define check_L_i_1(i) check_L_i_1[((-1 + N - i >= 0 && -1 + i >= 0) ? (i) : 0)]
#define check_L_j_0(j) check_L_j_0[((-1 + N - j >= 0 && -1 + j >= 0) ? (j) : 0)]
#define check_L_j_1(j) check_L_j_1[((-1 + N - j >= 0 && -1 + j >= 0) ? (j) : 0)]
...
#define check_U_i_1_NR(i0,i1) check_U_i_1_NR[((-2 + i0 >= 0 && -1 - i0 + i1 >= 0 && -1 + N - i1 >= 0) ? ((((-2 * N + (-1 + 2 * N) * i0 - i0*i0) + 2 * i1))/2) : (-i0 + i1 == 0 && -2 + i0 >= 0 && -1 + N - i0 >= 0) ? (((-2 * N + (1 + 2 * N) * i0 - i0*i0))/2) : (-1 + i0 == 0 && -1 + N - i1 >= 0 && -2 + i1 >= 0) ? ((-i0 + i1)) : 0)]
#define check_U_j_1_NR(i0,i1) check_U_j_1_NR[((-2 + i0 >= 0 && -1 - i0 + i1 >= 0 && -1 + N - i1 >= 0) ? ((((-2 * N + (-1 + 2 * N) * i0 - i0*i0) + 2 * i1))/2) : (-i0 + i1 == 0 && -2 + i0 >= 0 && -1 + N - i0 >= 0) ? (((-2 * N + (1 + 2 * N) * i0 - i0*i0))/2) : (-1 + i0 == 0 && -1 + N - i1 >= 0 && -2 + i1 >= 0) ? ((-i0 + i1)) : 0)]
#define check_L_i_1_NR(i0,i1) check_L_i_1_NR[((-2 + i0 >= 0 && -1 + N - i0 >= 0 && -2 + i1 >= 0 && i0 - i1 >= 0) ? ((((-2 - i0 + i0*i0) + 2 * i1))/2) : (-1 + i1 == 0 && -2 + i0 >= 0 && -1 + N - i0 >= 0) ? (((-i0 + i0*i0))/2) : 0)]
#define check_L_j_1_NR(i0,i1) check_L_j_1_NR[((-2 + i0 >= 0 && -1 + N - i0 >= 0 && -2 + i1 >= 0 && i0 - i1 >= 0) ? ((((-2 - i0 + i0*i0) + 2 * i1))/2) : (-1 + i1 == 0 && -2 + i0 >= 0 && -1 + N - i0 >= 0) ? (((-i0 + i0*i0))/2) : 0)]
...
#define _flag_check_U_i_inv(i) _flag_check_U_i_inv[((-1 + N - i >= 0 && -1 + i >= 0) ? (i) : 0)]
#define _flag_check_U_j_inv(j) _flag_check_U_j_inv[((-1 + N - j >= 0 && -1 + j >= 0) ? (j) : 0)]
#define _flag_check_L_i_inv(i) _flag_check_L_i_inv[((-1 + N - i >= 0 && -1 + i >= 0) ? (i) : 0)]
#define _flag_check_L_j_inv(j) _flag_check_L_j_inv[((-1 + N - j >= 0 && -1 + j >= 0) ? (j) : 0)]
...
#define _flag_check_U_i_1_NR(i0,i1) _flag_check_U_i_1_NR[((-2 + i0 >= 0 && -1 - i0 + i1 >= 0 && -1 + N - i1 >= 0) ? ((((-2 * N + (-1 + 2 * N) * i0 - i0*i0) + 2 * i1))/2) : (-i0 + i1 == 0 && -2 + i0 >= 0 && -1 + N - i0 >= 0) ? (((-2 * N + (1 + 2 * N) * i0 - i0*i0))/2) : (-1 + i0 == 0 && -1 + N - i1 >= 0 && -2 + i1 >= 0) ? ((-i0 + i1)) : 0)]
#define _flag_check_U_j_1_NR(i0,i1) _flag_check_U_j_1_NR[((-2 + i0 >= 0 && -1 - i0 + i1 >= 0 && -1 + N - i1 >= 0) ? ((((-2 * N + (-1 + 2 * N) * i0 - i0*i0) + 2 * i1))/2) : (-i0 + i1 == 0 && -2 + i0 >= 0 && -1 + N - i0 >= 0) ? (((-2 * N + (1 + 2 * N) * i0 - i0*i0))/2) : (-1 + i0 == 0 && -1 + N - i1 >= 0 && -2 + i1 >= 0) ? ((-i0 + i1)) : 0)]
#define _flag_check_L_i_1_NR(i0,i1) _flag_check_L_i_1_NR[((-2 + i0 >= 0 && -1 + N - i0 >= 0 && -2 + i1 >= 0 && i0 - i1 >= 0) ? ((((-2 - i0 + i0*i0) + 2 * i1))/2) : (-1 + i1 == 0 && -2 + i0 >= 0 && -1 + N - i0 >= 0) ? (((-i0 + i0*i0))/2) : 0)]
#define _flag_check_L_j_1_NR(i0,i1) _flag_check_L_j_1_NR[((-2 + i0 >= 0 && -1 + N - i0 >= 0 && -2 + i1 >= 0 && i0 - i1 >= 0) ? ((((-2 - i0 + i0*i0) + 2 * i1))/2) : (-1 + i1 == 0 && -2 + i0 >= 0 && -1 + N - i0 >= 0) ? (((-i0 + i0*i0))/2) : 0)]
...
static float eval_check_U_i_inv(long i);
...
static float eval_check_U_j_inv(long j);
...
static float eval_check_L_i_inv(long i);
...
static float eval_check_L_j_inv(long j);
...
static float reduce10(long N, long i0, long i1);
static float eval_check_U_i_1_NR(long i0, long i1);
static float reduce11(long N, long i0, long i1);
static float eval_check_U_j_1_NR(long i0, long i1);
static float reduce12(long N, long i0, long i1);
static float eval_check_L_i_1_NR(long i0, long i1);
static float reduce13(long N, long i0, long i1);
static float eval_check_L_j_1_NR(long i0, long i1);
void lud_aabft(long _local_N, float** _local_A, float** _local_L, float** _local_U, float* _local_check_U_i_inv, float* _local_check_U_j_inv, float* _local_check_L_i_inv, float* _local_check_L_j_inv);
...
static float eval_check_U_i_inv(long i) {
	...
	// Check the flags.
	if ((_flag_check_U_i_inv(i)) == ('N')) {
		_flag_check_U_i_inv(i) = 'I';
		check_U_i_inv(i) = ((eval_check_U_i_0(((i)))) - (eval_check_U_i_1(((i))))) / (eval_check_U_i_0(((i))));
		_flag_check_U_i_inv(i) = 'F';
	}
	else if ((_flag_check_U_i_inv(i)) == ('I')) {
		printf("There is a self dependence on check_U_i_inv at (%ld)\n",i);
		exit(-1);
	}
	
	return check_U_i_inv(i);
}
...
static float eval_check_U_j_inv(long j) {
	...
	// Check the flags.
	if ((_flag_check_U_j_inv(j)) == ('N')) {
		_flag_check_U_j_inv(j) = 'I';
		check_U_j_inv(j) = ((eval_check_U_j_0(((j)))) - (eval_check_U_j_1(((j))))) / (eval_check_U_j_0(((j))));
		_flag_check_U_j_inv(j) = 'F';
	}
	else if ((_flag_check_U_j_inv(j)) == ('I')) {
		printf("There is a self dependence on check_U_j_inv at (%ld)\n",j);
		exit(-1);
	}
	
	return check_U_j_inv(j);
}
...
static float eval_check_L_i_inv(long i) {
	...
	// Check the flags.
	if ((_flag_check_L_i_inv(i)) == ('N')) {
		_flag_check_L_i_inv(i) = 'I';
		check_L_i_inv(i) = ((eval_check_L_i_0(((i)))) - (eval_check_L_i_1(((i))))) / (eval_check_L_i_0(((i))));
		_flag_check_L_i_inv(i) = 'F';
	}
	else if ((_flag_check_L_i_inv(i)) == ('I')) {
		printf("There is a self dependence on check_L_i_inv at (%ld)\n",i);
		exit(-1);
	}
	
	return check_L_i_inv(i);
}
...
static float eval_check_L_j_inv(long j) {
	...
	// Check the flags.
	if ((_flag_check_L_j_inv(j)) == ('N')) {
		_flag_check_L_j_inv(j) = 'I';
		check_L_j_inv(j) = ((eval_check_L_j_0(((j)))) - (eval_check_L_j_1(((j))))) / (eval_check_L_j_0(((j))));
		_flag_check_L_j_inv(j) = 'F';
	}
	else if ((_flag_check_L_j_inv(j)) == ('I')) {
		printf("There is a self dependence on check_L_j_inv at (%ld)\n",j);
		exit(-1);
	}
	
	return check_L_j_inv(j);
}
...
static float eval_check_U_i_1_NR(long i0, long i1) {
	...
	// Check the flags.
	if ((_flag_check_U_i_1_NR(i0,i1)) == ('N')) {
		_flag_check_U_i_1_NR(i0,i1) = 'I';
		check_U_i_1_NR(i0,i1) = reduce10(N,i0,i1);
		_flag_check_U_i_1_NR(i0,i1) = 'F';
	}
	else if ((_flag_check_U_i_1_NR(i0,i1)) == ('I')) {
		printf("There is a self dependence on check_U_i_1_NR at (%ld,%ld)\n",i0,i1);
		exit(-1);
	}
	
	return check_U_i_1_NR(i0,i1);
}
...
static float eval_check_U_j_1_NR(long i0, long i1) {
	...
	// Check the flags.
	if ((_flag_check_U_j_1_NR(i0,i1)) == ('N')) {
		_flag_check_U_j_1_NR(i0,i1) = 'I';
		check_U_j_1_NR(i0,i1) = reduce11(N,i0,i1);
		_flag_check_U_j_1_NR(i0,i1) = 'F';
	}
	else if ((_flag_check_U_j_1_NR(i0,i1)) == ('I')) {
		printf("There is a self dependence on check_U_j_1_NR at (%ld,%ld)\n",i0,i1);
		exit(-1);
	}
	
	return check_U_j_1_NR(i0,i1);
}
...
static float eval_check_L_i_1_NR(long i0, long i1) {
	...
	// Check the flags.
	if ((_flag_check_L_i_1_NR(i0,i1)) == ('N')) {
		_flag_check_L_i_1_NR(i0,i1) = 'I';
		check_L_i_1_NR(i0,i1) = reduce12(N,i0,i1);
		_flag_check_L_i_1_NR(i0,i1) = 'F';
	}
	else if ((_flag_check_L_i_1_NR(i0,i1)) == ('I')) {
		printf("There is a self dependence on check_L_i_1_NR at (%ld,%ld)\n",i0,i1);
		exit(-1);
	}
	
	return check_L_i_1_NR(i0,i1);
}
...
static float eval_check_L_j_1_NR(long i0, long i1) {
	...
	// Check the flags.
	if ((_flag_check_L_j_1_NR(i0,i1)) == ('N')) {
		_flag_check_L_j_1_NR(i0,i1) = 'I';
		check_L_j_1_NR(i0,i1) = reduce13(N,i0,i1);
		_flag_check_L_j_1_NR(i0,i1) = 'F';
	}
	else if ((_flag_check_L_j_1_NR(i0,i1)) == ('I')) {
		printf("There is a self dependence on check_L_j_1_NR at (%ld,%ld)\n",i0,i1);
		exit(-1);
	}
	
	return check_L_j_1_NR(i0,i1);
}
...
void lud_aabft(long _local_N, float** _local_A, float** _local_L, float** _local_U, float* _local_check_U_i_inv, float* _local_check_U_j_inv, float* _local_check_L_i_inv, float* _local_check_L_j_inv) {
	...
	check_U_i_0 = (float*)(malloc((sizeof(float)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(check_U_i_0,"check_U_i_0");
	check_U_i_1 = (float*)(malloc((sizeof(float)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(check_U_i_1,"check_U_i_1");
	check_U_j_0 = (float*)(malloc((sizeof(float)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(check_U_j_0,"check_U_j_0");
	check_U_j_1 = (float*)(malloc((sizeof(float)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(check_U_j_1,"check_U_j_1");
	check_L_i_0 = (float*)(malloc((sizeof(float)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(check_L_i_0,"check_L_i_0");
	check_L_i_1 = (float*)(malloc((sizeof(float)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(check_L_i_1,"check_L_i_1");
	check_L_j_0 = (float*)(malloc((sizeof(float)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(check_L_j_0,"check_L_j_0");
	check_L_j_1 = (float*)(malloc((sizeof(float)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(check_L_j_1,"check_L_j_1");
	...
	_flag_check_U_i_inv = (char*)(malloc((sizeof(char)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(_flag_check_U_i_inv,"_flag_check_U_i_inv");
	memset(_flag_check_U_i_inv,'N',((-1 + N >= 0) ? (N) : 0));
	_flag_check_U_j_inv = (char*)(malloc((sizeof(char)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(_flag_check_U_j_inv,"_flag_check_U_j_inv");
	memset(_flag_check_U_j_inv,'N',((-1 + N >= 0) ? (N) : 0));
	_flag_check_L_i_inv = (char*)(malloc((sizeof(char)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(_flag_check_L_i_inv,"_flag_check_L_i_inv");
	memset(_flag_check_L_i_inv,'N',((-1 + N >= 0) ? (N) : 0));
	_flag_check_L_j_inv = (char*)(malloc((sizeof(char)) * (((-1 + N >= 0) ? (N) : 0))));
	mallocCheck(_flag_check_L_j_inv,"_flag_check_L_j_inv");
	memset(_flag_check_L_j_inv,'N',((-1 + N >= 0) ? (N) : 0));
	...
	#undef S1
	#define S2(i) eval_check_U_i_inv(i)
	for (i = 0; i < N; i += 1) {
		S2(i);
	}
	#undef S2
	#define S3(j) eval_check_U_j_inv(j)
	for (j = 0; j < N; j += 1) {
		S3(j);
	}
	#undef S3
	#define S4(i) eval_check_L_i_inv(i)
	for (i = 0; i < N; i += 1) {
		S4(i);
	}
	#undef S4
	#define S5(j) eval_check_L_j_inv(j)
	for (j = 0; j < N; j += 1) {
		S5(j);
	}
	#undef S5

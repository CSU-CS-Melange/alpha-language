...
float reduce_matmult_aabft_verify_check_C_i_0_1(long, int);
float eval_verify_check_C_i_0(long, int);
float reduce_matmult_aabft_verify_check_C_i_1_2(long, int, int);
float reduce_matmult_aabft_verify_check_C_i_1_1(long, int);
float eval_verify_check_C_i_1(long, int);
float eval_verify_check_C_i_inv(long, int);
float reduce_matmult_aabft_verify_check_C_j_0_1(long, int);
float eval_verify_check_C_j_0(long, int);
float reduce_matmult_aabft_verify_check_C_j_1_2(long, int, int);
float reduce_matmult_aabft_verify_check_C_j_1_1(long, int);
float eval_verify_check_C_j_1(long, int);
float eval_verify_check_C_j_inv(long, int);
...
void matmult_aabft_verify(long N, float** _local_A, float** _local_B, float** _local_C, float* _local_check_C_i_inv, float* _local_check_C_j_inv){
	...
	_flag_check_C_i_1 = (char*)malloc(sizeof(char)*(N));
	...
	#undef S0
	#define S0(j) eval_verify_check_C_j_inv(N,j)
	{
		//Domain
		//{j|j>=0 && N>=j+1 && N>=1}
		int c1;
...
float reduce_matmult_aabft_verify_check_C_i_0_1(long N, int ip){
	float reduceVar = 0;
...
float eval_verify_check_C_i_0(long N, int i){
	if ( _flag_check_C_i_0(i) == 'N' ) {
		_flag_check_C_i_0(i) = 'I';
	//Body for check_C_i_0
		check_C_i_0(i) = reduce_matmult_aabft_verify_check_C_i_0_1(N,i);
		_flag_check_C_i_0(i) = 'F';
	} else if ( _flag_check_C_i_0(i) == 'I' ) {
		printf("There is a self dependence on check_C_i_0 at (%d) \n",i);
		exit(-1);
	}
	return check_C_i_0(i);
}
float reduce_matmult_aabft_verify_check_C_i_1_2(long N, int ip, int jp){
	float reduceVar = 0;
	#define S0(i,j,k) reduceVar = (reduceVar)+((A(i,k))*(B(k,j)))
	{
		//Domain
...
float reduce_matmult_aabft_verify_check_C_i_1_1(long N, int ip){
	float reduceVar = 0;
	#define S0(i,j) reduceVar = (reduceVar)+(reduce_matmult_aabft_verify_check_C_i_1_2(N,i,j))
	{
		//Domain
		//{i,j|ip>=0 && N>=ip+1 && N>=1 && i>=0 && N>=i+1 && j>=0 && N>=j+1 && ip==i}
		int c2;
...
float eval_verify_check_C_i_1(long N, int i){
	if ( _flag_check_C_i_1(i) == 'N' ) {
		_flag_check_C_i_1(i) = 'I';
	//Body for check_C_i_1
		check_C_i_1(i) = reduce_matmult_aabft_verify_check_C_i_1_1(N,i);
		_flag_check_C_i_1(i) = 'F';
	} else if ( _flag_check_C_i_1(i) == 'I' ) {
		printf("There is a self dependence on check_C_i_1 at (%d) \n",i);
		exit(-1);
	}
	return check_C_i_1(i);
}
float eval_verify_check_C_i_inv(long N, int i){
	if ( _flag_check_C_i_inv(i) == 'N' ) {
		_flag_check_C_i_inv(i) = 'I';
	//Body for check_C_i_inv
		check_C_i_inv(i) = ((eval_verify_check_C_i_0(N,i))-(eval_verify_check_C_i_1(N,i)))/(eval_verify_check_C_i_0(N,i));
		_flag_check_C_i_inv(i) = 'F';
	} else if ( _flag_check_C_i_inv(i) == 'I' ) {
		printf("There is a self dependence on check_C_i_inv at (%d) \n",i);
		exit(-1);
	}
	return check_C_i_inv(i);
}
float reduce_matmult_aabft_verify_check_C_j_0_1(long N, int ip){
	float reduceVar = 0;
	#define S0(i,j) reduceVar = (reduceVar)+(eval_verify_C(N,i,j))
	{
		//Domain
...
float eval_verify_check_C_j_0(long N, int j){
	if ( _flag_check_C_j_0(j) == 'N' ) {
		_flag_check_C_j_0(j) = 'I';
	//Body for check_C_j_0
		check_C_j_0(j) = reduce_matmult_aabft_verify_check_C_j_0_1(N,j);
		_flag_check_C_j_0(j) = 'F';
	} else if ( _flag_check_C_j_0(j) == 'I' ) {
		printf("There is a self dependence on check_C_j_0 at (%d) \n",j);
		exit(-1);
	}
	return check_C_j_0(j);
}
float reduce_matmult_aabft_verify_check_C_j_1_2(long N, int ip, int jp){
	float reduceVar = 0;
	#define S0(i,j,k) reduceVar = (reduceVar)+((A(i,k))*(B(k,j)))
	{
		//Domain
...
float reduce_matmult_aabft_verify_check_C_j_1_1(long N, int ip){
	float reduceVar = 0;
	#define S0(i,j) reduceVar = (reduceVar)+(reduce_matmult_aabft_verify_check_C_j_1_2(N,i,j))
	{
		//Domain
		//{i,j|ip>=0 && N>=ip+1 && N>=1 && i>=0 && N>=i+1 && j>=0 && N>=j+1 && ip==j}
		int c1;
...
float eval_verify_check_C_j_1(long N, int j){
	if ( _flag_check_C_j_1(j) == 'N' ) {
		_flag_check_C_j_1(j) = 'I';
	//Body for check_C_j_1
		check_C_j_1(j) = reduce_matmult_aabft_verify_check_C_j_1_1(N,j);
		_flag_check_C_j_1(j) = 'F';
	} else if ( _flag_check_C_j_1(j) == 'I' ) {
		printf("There is a self dependence on check_C_j_1 at (%d) \n",j);
		exit(-1);
	}
	return check_C_j_1(j);
}
float eval_verify_check_C_j_inv(long N, int j){
	if ( _flag_check_C_j_inv(j) == 'N' ) {
		_flag_check_C_j_inv(j) = 'I';
	//Body for check_C_j_inv
		check_C_j_inv(j) = ((eval_verify_check_C_j_0(N,j))-(eval_verify_check_C_j_1(N,j)))/(eval_verify_check_C_j_0(N,j));
		_flag_check_C_j_inv(j) = 'F';
	} else if ( _flag_check_C_j_inv(j) == 'I' ) {
		printf("There is a self dependence on check_C_j_inv at (%d) \n",j);
		exit(-1);
	}

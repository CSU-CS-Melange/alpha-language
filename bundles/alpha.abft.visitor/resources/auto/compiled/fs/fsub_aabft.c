...
void fsub_aabft(long _local_N, float** _local_L, float* _local_b, float* _local_x, float* _local_check_x_i_0, float* _local_check_x_i_1, float* _local_check_x_i_inv);

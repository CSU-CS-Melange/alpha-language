...
#define check_B_i_0_verify(i) check_B_i_0_verify[i]
#define check_B_i_1_verify(i) check_B_i_1_verify[i]
#define check_B_i_inv_verify(i) check_B_i_inv_verify[i]
#define check_B_j_0_verify(j) check_B_j_0_verify[j]
#define check_B_j_1_verify(j) check_B_j_1_verify[j]
#define check_B_j_inv_verify(j) check_B_j_inv_verify[j]
#define var_B(i,j) B(i,j)
#define var_B_verify(i,j) B_verify(i,j)
#define var_check_B_i_0(i) check_B_i_0(i)
#define var_check_B_i_0_verify(i) check_B_i_0_verify(i)
#define var_check_B_i_1(i) check_B_i_1(i)
#define var_check_B_i_1_verify(i) check_B_i_1_verify(i)
#define var_check_B_i_inv(i) check_B_i_inv(i)
#define var_check_B_i_inv_verify(i) check_B_i_inv_verify(i)
#define var_check_B_j_0(j) check_B_j_0(j)
#define var_check_B_j_0_verify(j) check_B_j_0_verify(j)
#define var_check_B_j_1(j) check_B_j_1(j)
#define var_check_B_j_1_verify(j) check_B_j_1_verify(j)
#define var_check_B_j_inv(j) check_B_j_inv(j)
#define var_check_B_j_inv_verify(j) check_B_j_inv_verify(j)

//function prototypes
void scalmat_aabft(long, float*, float**, float**, float*, float*, float*, float*, float*, float*);
void scalmat_aabft_verify(long, float*, float**, float**, float*, float*, float*, float*, float*, float*);
...
int main(int argc, char** argv) {
	...
	float* check_B_i_0 = (float*)malloc(sizeof(float)*(N));
	mallocCheck(check_B_i_0, (N), float);
	float* check_B_i_1 = (float*)malloc(sizeof(float)*(N));
	mallocCheck(check_B_i_1, (N), float);
	float* check_B_i_inv = (float*)malloc(sizeof(float)*(N));
	mallocCheck(check_B_i_inv, (N), float);
	float* check_B_j_0 = (float*)malloc(sizeof(float)*(N));
	mallocCheck(check_B_j_0, (N), float);
	float* check_B_j_1 = (float*)malloc(sizeof(float)*(N));
	...
	mallocCheck(check_B_j_inv, (N), float);
		...
		float* check_B_i_0_verify = (float*)malloc(sizeof(float)*(N));
		mallocCheck(check_B_i_0_verify, (N), float);
		float* check_B_i_1_verify = (float*)malloc(sizeof(float)*(N));
		mallocCheck(check_B_i_1_verify, (N), float);
		float* check_B_i_inv_verify = (float*)malloc(sizeof(float)*(N));
		mallocCheck(check_B_i_inv_verify, (N), float);
		float* check_B_j_0_verify = (float*)malloc(sizeof(float)*(N));
		mallocCheck(check_B_j_0_verify, (N), float);
		float* check_B_j_1_verify = (float*)malloc(sizeof(float)*(N));
		mallocCheck(check_B_j_1_verify, (N), float);
	...
	scalmat_aabft(N, &k, A, B, check_B_i_0, check_B_i_1, check_B_i_inv, check_B_j_0, check_B_j_1, check_B_j_inv);
	...
	//Verification Run
			...
			elapsed_time = (((double) time.tv_sec) + ((double) time.tv_usec)/1000000);
		#endif
    	scalmat_aabft_verify(N, &k, A, B_verify, check_B_i_0_verify, check_B_i_1_verify, check_B_i_inv_verify, check_B_j_0_verify, check_B_j_1_verify, check_B_j_inv_verify);
    	#ifdef TIMING
    		gettimeofday(&time, NULL);
			elapsed_time = (((double) time.tv_sec) + ((double) time.tv_usec)/1000000) - elapsed_time;
		...
		
		{
			...
			#else
				#define S0(i) printf("check_B_i_0(%ld)=",(long) i);printf("%0.2f\n",var_check_B_i_0(i))
			#endif
			int c1;
			for(c1=0;c1 <= N-1;c1+=1)
			 {
		...
		
		{
				...
				#define S0(i) printf("%0.2f\n",var_check_B_i_1(i))
			#else
				#define S0(i) printf("check_B_i_1(%ld)=",(long) i);printf("%0.2f\n",var_check_B_i_1(i))
			#endif
			int c1;
			for(c1=0;c1 <= N-1;c1+=1)
			 {
		...
		
		{
			...
			#else
				#define S0(j) printf("check_B_j_0(%ld)=",(long) j);printf("%0.2f\n",var_check_B_j_0(j))
			#endif
			int c1;
			for(c1=0;c1 <= N-1;c1+=1)
			 {
		...
		
		{
				...
				#define S0(j) printf("%0.2f\n",var_check_B_j_1(j))
			#else
				#define S0(j) printf("check_B_j_1(%ld)=",(long) j);printf("%0.2f\n",var_check_B_j_1(j))
			#endif
			int c1;
			for(c1=0;c1 <= N-1;c1+=1)
			 {
		...
		}
		{
			//Error Counter
			int _errors_ = 0;
			#define S0(i) if (fabsf(1.0f - var_check_B_i_0_verify(i)/var_check_B_i_0(i)) > EPSILON) _errors_++;
			int c1;
			for(c1=0;c1 <= N-1;c1+=1)
			 {
			 	S0((c1));
			...
			if(_errors_ == 0){
				...
				printf("TEST for check_B_i_0 FAILED. #Errors: %d\n", _errors_);
			}
		}
		{
			//Error Counter
			int _errors_ = 0;
			#define S0(i) if (fabsf(1.0f - var_check_B_i_1_verify(i)/var_check_B_i_1(i)) > EPSILON) _errors_++;
			int c1;
			for(c1=0;c1 <= N-1;c1+=1)
			 {
			 	S0((c1));
			...
			if(_errors_ == 0){
				...
				printf("TEST for check_B_i_1 FAILED. #Errors: %d\n", _errors_);
			}
		}
		{
			//Error Counter
		...
		}
		{
			//Error Counter
			int _errors_ = 0;
			#define S0(j) if (fabsf(1.0f - var_check_B_j_0_verify(j)/var_check_B_j_0(j)) > EPSILON) _errors_++;
			int c1;
			for(c1=0;c1 <= N-1;c1+=1)
			 {
			 	S0((c1));
			...
			#undef S0
			if(_errors_ == 0){
				printf("TEST for check_B_j_0 PASSED\n");
			}else{
				printf("TEST for check_B_j_0 FAILED. #Errors: %d\n", _errors_);
			}
		}
		{
			//Error Counter
			int _errors_ = 0;
			#define S0(j) if (fabsf(1.0f - var_check_B_j_1_verify(j)/var_check_B_j_1(j)) > EPSILON) _errors_++;
			int c1;
			for(c1=0;c1 <= N-1;c1+=1)
			 {
			 	S0((c1));
			...
			#undef S0
			if(_errors_ == 0){
				printf("TEST for check_B_j_1 PASSED\n");
			}else{
				printf("TEST for check_B_j_1 FAILED. #Errors: %d\n", _errors_);
			}
		}
		{
			//Error Counter
	...
	free(check_B_j_inv);
		...
		free(_lin_B_verify);
		free(B_verify);
		free(check_B_i_0_verify);
		free(check_B_i_1_verify);
		free(check_B_i_inv_verify);
		free(check_B_j_0_verify);
		free(check_B_j_1_verify);

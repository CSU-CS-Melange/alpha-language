...
void lud_aabft_verify(long N, float** _local_A, float** _local_L, float** _local_U, float* _local_check_U_i_0, float* _local_check_U_i_1, float* _local_check_U_j_0, float* _local_check_U_j_1, float* _local_check_L_i_0, float* _local_check_L_i_1, float* _local_check_L_j_0, float* _local_check_L_j_1){
	///Parameter checking
	if (!((N >= 1))) {

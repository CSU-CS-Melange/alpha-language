...
class ABFTv2 extends ABFTv1 {
	
	def static void main(String[] args) {
		
		'star2d1r'.insertChecksum(#[16, 10, 10])
...
//		system.outputs.add(IVar)
		...
		systemBody.addC1Equation(C1Var, outputVar, WVar, tileSizes, radius)
	...
	def static buildSpatialContext(int[] tileSizes, int radius, String[] CIndexNames, String[] spatialIndexNames) {
		val TT = tileSizes.get(0)
		tileSizes.buildSpatialContext(radius, CIndexNames, spatialIndexNames, 2*radius*TT)
	}

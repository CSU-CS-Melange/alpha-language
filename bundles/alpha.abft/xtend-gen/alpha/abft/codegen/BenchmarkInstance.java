...
public class BenchmarkInstance {
  ...
  public static CharSequence v3Schedule(final AlphaSystem system, final int[] tileSizes) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append("  ");
      _builder.append("- filter: \"{ C1\'; C2\'; C2_NR\'; C2_NR2\'; C2_NR3\'; C2_NR4\'; I\'; ");
      String _join = IterableExtensions.join(yStmts, "; ");
      _builder.append(_join, "  ");
      _builder.append(" }\"");
      _builder.newLineIfNotEmpty();
      ...
      _builder.newLineIfNotEmpty();
      _builder.append("          ");
      _builder.append("C2\'->[t]; \\");
      _builder.newLine();
      _builder.append("          ");
      _builder.append("C2_NR\'->[t]; \\");
      _builder.newLine();
      _builder.append("          ");
      _builder.append("C2_NR2\'->[t]; \\");
      _builder.newLine();
      _builder.append("          ");
      _builder.append("C2_NR3\'->[t]; \\");
      _builder.newLine();
      _builder.append("          ");
      _builder.append("C2_NR4\'->[t]; \\");
      _builder.newLine();
      _builder.append("          ");
      _builder.append("I\'->[");
      _builder.append(H, "          ");

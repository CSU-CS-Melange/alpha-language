...
public class ABFTv3 extends ABFTv1 {
  ...
  public static AlphaSystem insertChecksum(final AlphaSystem system, final int[] tileSizes, final boolean renameSystem) {
    AlphaSystem _xblockexpression = null;
    {
      ...
      ABFTv3.addC2Equation(systemBody, CiVar, outputVar, WVar, convolutionKernel, spaceTileDim, H, L);
  ...
  public static List<AlphaIssue> addC2Equation(final SystemBody systemBody, final Variable CVar, final Variable stencilVar, final Variable WVar, final ConvolutionKernel convolutionKernel, final int spaceTileDim, final int H, final int L) {
    List<AlphaIssue> _xblockexpression = null;
    {
  ...
  public static List<AlphaIssue> addWiEquation(final SystemBody systemBody, final Variable WiVar, final Variable WExtVar, final Variable WVar, final int spaceTileDim) {
    List<AlphaIssue> _xblockexpression = null;
    {
      ...
      final String pqrName = ((String[])Conversions.unwrapArray(ABFTv3.getKernelNamesV3(WiVar.getDomain()), String.class))[spaceTileDim];

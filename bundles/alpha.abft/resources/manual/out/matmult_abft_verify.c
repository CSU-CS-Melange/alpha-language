...
float reduce_matmult_abft_verify_C_1(long, int, int);
float eval_verify_C(long, int, int);
float reduce_matmult_abft_verify_C_r_0_1(long, int);
float eval_verify_C_r_0(long, int);
float reduce_matmult_abft_verify_C_r_1_1(long, int);
float eval_verify_C_r_1(long, int);
float reduce_matmult_abft_verify_C_c_0_1(long, int);
float eval_verify_C_c_0(long, int);
float reduce_matmult_abft_verify_C_c_1_1(long, int);
...
void matmult_abft_verify(long N, float** _local_A, float** _local_B, float** _local_C, float* _local_Inv_C_r, float* _local_Inv_C_c){
	///Parameter checking
	if (!((N >= 1))) {
...
float reduce_matmult_abft_verify_C_1(long N, int ip, int jp){
	float reduceVar = 0;
...
float eval_verify_C(long N, int i, int j){
	if ( _flag_C(i,j) == 'N' ) {
		_flag_C(i,j) = 'I';
	//Body for C
		C(i,j) = reduce_matmult_abft_verify_C_1(N,i,j);
		_flag_C(i,j) = 'F';
...
float reduce_matmult_abft_verify_C_r_0_1(long N, int ip){
	float reduceVar = 0;
...
float eval_verify_C_r_0(long N, int i){
	if ( _flag_C_r_0(i) == 'N' ) {
		_flag_C_r_0(i) = 'I';
	//Body for C_r_0
		C_r_0(i) = reduce_matmult_abft_verify_C_r_0_1(N,i);
		_flag_C_r_0(i) = 'F';
...
float reduce_matmult_abft_verify_C_r_1_1(long N, int ip){
	float reduceVar = 0;
	#define S0(i,j,k) reduceVar = (reduceVar)+((A(i,k))*(B(k,j)))
	{
		//Domain
...
float eval_verify_C_r_1(long N, int i){
	if ( _flag_C_r_1(i) == 'N' ) {
		_flag_C_r_1(i) = 'I';
	//Body for C_r_1
		C_r_1(i) = reduce_matmult_abft_verify_C_r_1_1(N,i);
		_flag_C_r_1(i) = 'F';
...
float reduce_matmult_abft_verify_C_c_0_1(long N, int jp){
	float reduceVar = 0;
...
float eval_verify_C_c_0(long N, int j){
	if ( _flag_C_c_0(j) == 'N' ) {
		_flag_C_c_0(j) = 'I';
	//Body for C_c_0
		C_c_0(j) = reduce_matmult_abft_verify_C_c_0_1(N,j);
		_flag_C_c_0(j) = 'F';
...
float reduce_matmult_abft_verify_C_c_1_1(long N, int jp){
	float reduceVar = 0;
...
float eval_verify_C_c_1(long N, int j){
	if ( _flag_C_c_1(j) == 'N' ) {
		_flag_C_c_1(j) = 'I';
	//Body for C_c_1
		C_c_1(j) = reduce_matmult_abft_verify_C_c_1_1(N,j);
		_flag_C_c_1(j) = 'F';

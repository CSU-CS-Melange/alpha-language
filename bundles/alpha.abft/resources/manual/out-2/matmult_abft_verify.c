...
float reduce_matmult_abft_verify_C_C_i_0_1(long, int);
float eval_verify_C_C_i_0(long, int);
float reduce_matmult_abft_verify_C_C_i_1_1(long, int);
...
void matmult_abft_verify(long N, float** _local_A, float** _local_B, float** _local_C, float* _local_Inv_C_i){
	///Parameter checking
	if (!((N >= 1))) {
	...
	C_C_i_0 = (float*)malloc(sizeof(float)*(N));
	mallocCheck(C_C_i_0, (N), float);
	
	C_C_i_1 = (float*)malloc(sizeof(float)*(N));
...
float reduce_matmult_abft_verify_C_C_i_0_1(long N, int ip){
	float reduceVar = 0;
...
float eval_verify_C_C_i_0(long N, int i){
	if ( _flag_C_C_i_0(i) == 'N' ) {
		_flag_C_C_i_0(i) = 'I';
	//Body for C_C_i_0
		C_C_i_0(i) = reduce_matmult_abft_verify_C_C_i_0_1(N,i);
		_flag_C_C_i_0(i) = 'F';
...
float reduce_matmult_abft_verify_C_C_i_1_1(long N, int ip){
	float reduceVar = 0;
	#define S0(i,j,k) reduceVar = (reduceVar)+((A(i,k))*(B(k,j)))
	{
		//Domain
...
float eval_verify_C_C_i_1(long N, int i){
	if ( _flag_C_C_i_1(i) == 'N' ) {
		_flag_C_C_i_1(i) = 'I';
	//Body for C_C_i_1
		C_C_i_1(i) = reduce_matmult_abft_verify_C_C_i_1_1(N,i);
		_flag_C_C_i_1(i) = 'F';

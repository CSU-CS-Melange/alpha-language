...
float reduce_lud_aabft_verify_L_c_0_1(long, int);
float eval_verify_L_c_0(long, int);
float reduce_lud_aabft_verify_L_c_1_2(long, int, int);
float reduce_lud_aabft_verify_L_c_1_1(long, int);
float eval_verify_L_c_1(long, int);
float reduce_lud_aabft_verify_U_r_0_1(long, int);
float eval_verify_U_r_0(long, int);
float reduce_lud_aabft_verify_U_r_1_2(long, int, int);
float reduce_lud_aabft_verify_U_r_1_1(long, int);
...
void lud_aabft_verify(long N, float** _local_A, float** _local_L, float** _local_U, float* _local_Inv_L_c, float* _local_Inv_U_r){
	///Parameter checking
	if (!((N >= 1))) {
...
float reduce_lud_aabft_verify_L_c_0_1(long N, int ip){
	float reduceVar = 0;
...
float eval_verify_L_c_0(long N, int j){
	if ( _flag_L_c_0(j) == 'N' ) {
		_flag_L_c_0(j) = 'I';
	//Body for L_c_0
		L_c_0(j) = reduce_lud_aabft_verify_L_c_0_1(N,j);
		_flag_L_c_0(j) = 'F';
...
float reduce_lud_aabft_verify_L_c_1_2(long N, int ip, int jp){
	float reduceVar = 0;
	#define S0(i,j,k) reduceVar = (reduceVar)+((eval_verify_L(N,i,k))*(eval_verify_U(N,k,j)))
	{
		//Domain
...
float reduce_lud_aabft_verify_L_c_1_1(long N, int ip){
	float reduceVar = 0;
	#define S0(i,j) reduceVar = (reduceVar)+((((j == 0 && N >= i+1 && i >= 0))?(A(i,j))/(eval_verify_U(N,j,j)):(((A(i,j))-(reduce_lud_aabft_verify_L_c_1_2(N,i,j)))/(eval_verify_U(N,j,j)))))
	{
		//Domain
...
float eval_verify_L_c_1(long N, int j){
	if ( _flag_L_c_1(j) == 'N' ) {
		_flag_L_c_1(j) = 'I';
	//Body for L_c_1
		L_c_1(j) = reduce_lud_aabft_verify_L_c_1_1(N,j);
		_flag_L_c_1(j) = 'F';
...
float reduce_lud_aabft_verify_U_r_0_1(long N, int ip){
	float reduceVar = 0;
...
float eval_verify_U_r_0(long N, int i){
	if ( _flag_U_r_0(i) == 'N' ) {
		_flag_U_r_0(i) = 'I';
	//Body for U_r_0
		U_r_0(i) = reduce_lud_aabft_verify_U_r_0_1(N,i);
		_flag_U_r_0(i) = 'F';
...
float reduce_lud_aabft_verify_U_r_1_2(long N, int ip, int jp){
	float reduceVar = 0;
	#define S0(i,j,k) reduceVar = (reduceVar)+((eval_verify_L(N,i,k))*(eval_verify_U(N,k,j)))
	{
		//Domain
...
float reduce_lud_aabft_verify_U_r_1_1(long N, int ip){
	float reduceVar = 0;
	#define S0(i,j) reduceVar = (reduceVar)+((((i == 0 && N >= j+1 && j >= 0))?A(i,j):((A(i,j))-(reduce_lud_aabft_verify_U_r_1_2(N,i,j)))))
	{
		//Domain
...
float eval_verify_U_r_1(long N, int i){
	if ( _flag_U_r_1(i) == 'N' ) {
		_flag_U_r_1(i) = 'I';
	//Body for U_r_1
		U_r_1(i) = reduce_lud_aabft_verify_U_r_1_1(N,i);
		_flag_U_r_1(i) = 'F';

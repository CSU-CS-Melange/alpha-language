...
float reduce_matmult_verify_C_1(long, int, int);
float eval_verify_C(long, int, int);
float reduce_matmult_verify_C_C_i_0_1(long, int);
float eval_verify_C_C_i_0(long, int);
float reduce_matmult_verify_C_C_i_1_1(long, int);
float eval_verify_C_C_i_1(long, int);
float reduce_matmult_verify_C_C_j_0_1(long, int);
float eval_verify_C_C_j_0(long, int);
float reduce_matmult_verify_C_C_j_1_1(long, int);
...
void matmult_verify(long N, float** _local_A, float** _local_B, float** _local_C, float* _local_Inv_C_i, float* _local_Inv_C_j, float* _local_C_C_i_0, float* _local_C_C_i_1, float* _local_C_C_j_0, float* _local_C_C_j_1){
	///Parameter checking
	if (!((N >= 1))) {
...
float reduce_matmult_verify_C_1(long N, int ip, int jp){
	float reduceVar = 0;
...
float eval_verify_C(long N, int i, int j){
	if ( _flag_C(i,j) == 'N' ) {
		_flag_C(i,j) = 'I';
	//Body for C
		C(i,j) = reduce_matmult_verify_C_1(N,i,j);
		_flag_C(i,j) = 'F';
...
float reduce_matmult_verify_C_C_i_0_1(long N, int ip){
	float reduceVar = 0;
...
float eval_verify_C_C_i_0(long N, int i){
	if ( _flag_C_C_i_0(i) == 'N' ) {
		_flag_C_C_i_0(i) = 'I';
	//Body for C_C_i_0
		C_C_i_0(i) = reduce_matmult_verify_C_C_i_0_1(N,i);
		_flag_C_C_i_0(i) = 'F';
...
float reduce_matmult_verify_C_C_i_1_1(long N, int ip){
	float reduceVar = 0;
	#define S0(i,j,k) reduceVar = (reduceVar)+((A(i,k))*(B(k,j)))
	{
		//Domain
...
float eval_verify_C_C_i_1(long N, int i){
	if ( _flag_C_C_i_1(i) == 'N' ) {
		_flag_C_C_i_1(i) = 'I';
	//Body for C_C_i_1
		C_C_i_1(i) = reduce_matmult_verify_C_C_i_1_1(N,i);
		_flag_C_C_i_1(i) = 'F';
...
float reduce_matmult_verify_C_C_j_0_1(long N, int ip){
	float reduceVar = 0;
	#define S0(i,j) reduceVar = (reduceVar)+(eval_verify_C(N,i,j))
	{
		//Domain
...
float eval_verify_C_C_j_0(long N, int j){
	if ( _flag_C_C_j_0(j) == 'N' ) {
		_flag_C_C_j_0(j) = 'I';
	//Body for C_C_j_0
		C_C_j_0(j) = reduce_matmult_verify_C_C_j_0_1(N,j);
		_flag_C_C_j_0(j) = 'F';
...
float reduce_matmult_verify_C_C_j_1_1(long N, int ip){
	float reduceVar = 0;
	#define S0(i,j,k) reduceVar = (reduceVar)+((A(i,k))*(B(k,j)))
	{
		//Domain
...
float eval_verify_C_C_j_1(long N, int j){
	if ( _flag_C_C_j_1(j) == 'N' ) {
		_flag_C_C_j_1(j) = 'I';
	//Body for C_C_j_1
		C_C_j_1(j) = reduce_matmult_verify_C_C_j_1_1(N,j);
		_flag_C_C_j_1(j) = 'F';

...
//function prototypes
void matmult(long, float**, float**, float**, float*, float*, float*, float*, float*, float*);
void matmult_verify(long, float**, float**, float**, float*, float*, float*, float*, float*, float*);
...
int main(int argc, char** argv) {
	...
	matmult(N, A, B, C, Inv_C_i, Inv_C_j, C_C_i_0, C_C_i_1, C_C_j_0, C_C_j_1);
	...
	//Verification Run
			...
			elapsed_time = (((double) time.tv_sec) + ((double) time.tv_usec)/1000000);
		#endif
    	matmult_verify(N, A, B, C_verify, Inv_C_i_verify, Inv_C_j_verify, C_C_i_0_verify, C_C_i_1_verify, C_C_j_0_verify, C_C_j_1_verify);
    	#ifdef TIMING
    		gettimeofday(&time, NULL);
			elapsed_time = (((double) time.tv_sec) + ((double) time.tv_usec)/1000000) - elapsed_time;

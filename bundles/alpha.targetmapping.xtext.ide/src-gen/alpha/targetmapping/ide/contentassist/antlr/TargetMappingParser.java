...
public class TargetMappingParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TargetMappingGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFixedSizeTilingTileLoopSpecificationAccess().getLoopScheduleExprAlternatives_6_0(), "rule__FixedSizeTilingTileLoopSpecification__LoopScheduleExprAlternatives_6_0");
			builder.put(grammarAccess.getParametricTilingTileLoopSpecificationAccess().getLoopScheduleExprAlternatives_6_0(), "rule__ParametricTilingTileLoopSpecification__LoopScheduleExprAlternatives_6_0");
			builder.put(grammarAccess.getCompileTimeConstantTilingTileLoopSpecificationAccess().getLoopScheduleExprAlternatives_6_0(), "rule__CompileTimeConstantTilingTileLoopSpecification__LoopScheduleExprAlternatives_6_0");
			...
			builder.put(grammarAccess.getFullTileSpecificationAccess().getGroup(), "rule__FullTileSpecification__Group__0");
			builder.put(grammarAccess.getFullTileSpecificationAccess().getGroup_2(), "rule__FullTileSpecification__Group_2__0");
			builder.put(grammarAccess.getFullTileSpecificationAccess().getGroup_2_2(), "rule__FullTileSpecification__Group_2_2__0");
			...
			builder.put(grammarAccess.getFixedSizeTilingTileLoopSpecificationAccess().getParallelAssignment_1(), "rule__FixedSizeTilingTileLoopSpecification__ParallelAssignment_1");
			...
			builder.put(grammarAccess.getFixedSizeTilingTileLoopSpecificationAccess().getLoopScheduleExprAssignment_6(), "rule__FixedSizeTilingTileLoopSpecification__LoopScheduleExprAssignment_6");
			builder.put(grammarAccess.getFixedSizeTilingTileLoopSpecificationAccess().getTilingSpecificationAssignment_7(), "rule__FixedSizeTilingTileLoopSpecification__TilingSpecificationAssignment_7");
			builder.put(grammarAccess.getParametricTilingTileLoopSpecificationAccess().getParallelAssignment_1(), "rule__ParametricTilingTileLoopSpecification__ParallelAssignment_1");
			...
			builder.put(grammarAccess.getParametricTilingTileLoopSpecificationAccess().getLoopScheduleExprAssignment_6(), "rule__ParametricTilingTileLoopSpecification__LoopScheduleExprAssignment_6");
			builder.put(grammarAccess.getParametricTilingTileLoopSpecificationAccess().getTilingSpecificationAssignment_7(), "rule__ParametricTilingTileLoopSpecification__TilingSpecificationAssignment_7");
			builder.put(grammarAccess.getCompileTimeConstantTilingTileLoopSpecificationAccess().getParallelAssignment_1(), "rule__CompileTimeConstantTilingTileLoopSpecification__ParallelAssignment_1");
			...
			builder.put(grammarAccess.getCompileTimeConstantTilingTileLoopSpecificationAccess().getLoopScheduleExprAssignment_6(), "rule__CompileTimeConstantTilingTileLoopSpecification__LoopScheduleExprAssignment_6");
			builder.put(grammarAccess.getCompileTimeConstantTilingTileLoopSpecificationAccess().getTilingSpecificationAssignment_7(), "rule__CompileTimeConstantTilingTileLoopSpecification__TilingSpecificationAssignment_7");
			builder.put(grammarAccess.getPointLoopSpecificationAccess().getLoopTypeSpecificationsAssignment_2(), "rule__PointLoopSpecification__LoopTypeSpecificationsAssignment_2");
			builder.put(grammarAccess.getPointLoopSpecificationAccess().getFullTileSpecificationAssignment_3(), "rule__PointLoopSpecification__FullTileSpecificationAssignment_3");
			builder.put(grammarAccess.getFullTileSpecificationAccess().getLoopTypeSpecificationsAssignment_2_1(), "rule__FullTileSpecification__LoopTypeSpecificationsAssignment_2_1");
			builder.put(grammarAccess.getFullTileSpecificationAccess().getLoopTypeSpecificationsAssignment_2_2_1(), "rule__FullTileSpecification__LoopTypeSpecificationsAssignment_2_2_1");

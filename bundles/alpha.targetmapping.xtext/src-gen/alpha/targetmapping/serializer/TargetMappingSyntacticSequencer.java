...
public class TargetMappingSyntacticSequencer extends AbstractSyntacticSequencer {

	protected TargetMappingGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (TargetMappingGrammarAccess) access;

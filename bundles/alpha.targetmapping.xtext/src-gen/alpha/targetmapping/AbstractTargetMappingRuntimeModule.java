...
import alpha.targetmapping.scoping.TargetMappingScopeProvider;
...
public abstract class AbstractTargetMappingRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "alpha/targetmapping/TargetMapping.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("alpha.targetmapping.TargetMapping");
	}
	...
	public Class<? extends IGrammarAccess> bindIGrammarAccess() {
		return TargetMappingGrammarAccess.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return TargetMappingSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return TargetMappingSyntacticSequencer.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return TargetMappingAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalTargetMappingLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalTargetMappingLexer> provideInternalTargetMappingLexer() {
		return LexerProvider.create(InternalTargetMappingLexer.class);
	}
	...
	public Class<? extends IScopeProvider> bindIScopeProvider() {
		return TargetMappingScopeProvider.class;
	}
	...
	public Class<? extends IFormatter2> bindIFormatter2() {
		return TargetMappingFormatter.class;
	}
